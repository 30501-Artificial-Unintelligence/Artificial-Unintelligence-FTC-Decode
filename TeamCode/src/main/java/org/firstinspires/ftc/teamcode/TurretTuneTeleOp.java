...
@TeleOp(name = "Turret Manual Tune", group = "Test")
public class TurretTuneTeleOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Align turret to the intake, then record RAW angle.");
        telemetry.update();
